...
import Home from "./views/main/home/components/Home";
...
import Sidebar from "views/main/pages/components/Sidebar";
    ...
    <Provider store={store}>
      ...
      <BrowserRouter>
        <Routes>
          ...
          {/* <Route path="/analytics" name="home" element={<MainRoute />}>
          ...
          <Route path="/" name="analytics" element={<MainRoute />}>
            <Route path="/analytics" element={<Analytics />}>
              <Route path=":groupId" element={<Sidebar />}/>
            </Route>
          </Route>
